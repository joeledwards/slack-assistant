...
tap.test('makeConversationKey should return null given an invalid input event', assert => {
...
tap.test('makeConversationKey should create a valid conversation key given a valid event', assert => {
